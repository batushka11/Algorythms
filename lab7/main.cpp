...
void bucket_sort(int* array, const int sz, const int bucket_count, int max) {
    const int bucket_size = (max + 1 + bucket_count - 1) / bucket_count;
...
void test() {
    ...
    for (int o = 1; o < MAX_ORDER; o++) {
        ...
        t1 = clock();
        binary_heap<int>::sort(array2, n, true, [](const int &a, const int &b) {
            return a > b;
        });
        t2 = clock();
        ...
        t1 = clock();
        bucket_sort(array3, n, sqrt(n), max);
        t2 = clock();
...
void experiment_sorting() {
    ...
    for (int o = 1; o < MAX_ORDER; o++) {
        ...
        t1 = clock();
        bucket_sort(array2, n, sqrt(n), some_object_key, std::function(
